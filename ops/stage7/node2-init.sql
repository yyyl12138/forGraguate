-- Stage 7 host-install initialization for node2.
-- This script creates only the node2 plaintext replica schema.

CREATE DATABASE IF NOT EXISTS logtrace_node2
  DEFAULT CHARACTER SET utf8mb4
  DEFAULT COLLATE utf8mb4_bin;

CREATE TABLE IF NOT EXISTS logtrace_node2.log_records (
...
CREATE TABLE IF NOT EXISTS logtrace_node2.log_batches (
  batch_id VARCHAR(96) NOT NULL,
  source VARCHAR(64) NOT NULL,
  source_node ENUM('node1', 'node2', 'node3') NOT NULL,
